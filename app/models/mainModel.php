<?php
	...
	class mainModel{
		...
		/*----------  Funcion limpiar cadenas  y evitar inyecciones SQL ----------*/
		public function limpiarCadena($cadena){
			//palabras o caracteres que se desean eliminar para evitar inyecciones sql
			$palabras=["<script>","</script>","<script src","<script type=","SELECT * FROM","SELECT "," SELECT ","DELETE FROM","INSERT INTO","DROP TABLE","DROP DATABASE","TRUNCATE TABLE","SHOW TABLES","SHOW DATABASES","<?php","?>","--","^","<",">","==","=",";","::"];

			//elimina los espacios en blanco al inicio y final de la cadena
			$cadena=trim($cadena);
			//elimina las barras invertidas de una cadena
			$cadena=stripslashes($cadena);

			//elimina las palabras o caracteres no permitidos para evitar inyecciones sql
